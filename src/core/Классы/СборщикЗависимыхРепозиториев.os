...
Функция НайтиРепозиторииНаСтранице(ИмяПакета, НомерСтраницы, ШагДиапазонаРазмераФайла, ТолькоФорки, НайденныеРепозитории)
	...
	Попытка
		Ответ = ЗапроситьИспользованияПакетаВКоде(ИмяПакета, НомерСтраницы, ШагДиапазонаРазмераФайла, ТолькоФорки);
	Исключение
...
Функция ЗапроситьИспользованияПакетаВКоде(ИмяПакета, НомерСтраницы, ШагДиапазонаРазмераФайла, ТолькоФорки)
